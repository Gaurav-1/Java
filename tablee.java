...
{ 
	...
	t1.setText(t1.getText()+" | "+a+" x \n "+String.valueOf(count)+" = "+s1);
	t2.setText(t2.getText()+" | "+b+" x \n "+String.valueOf(count)+" = "+s2);
	t3.setText(t3.getText()+" | "+c+" x \n "+String.valueOf(count)+" = "+s3);
	count++;
}}}
